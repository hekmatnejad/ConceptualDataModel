package com.cognitivemedicine.util;
...
public class KBFacilitator implements KBSessionInterface {
    ...
    public KBFacilitator(boolean readFromFile, String drlFileName, String drlSource, Engine engine, boolean isTrait) throws Exception{
        this.engine = engine;
    ...
    @Override
    public void createKBFacilitator(boolean readFromFile, String drlFileName, String drlSource, Engine engine, boolean isTrait) throws Exception{
    ...
    @Override
    public void setGloabl(String key, Object value) {
        kieSession.setGlobal(key, value);
    }

    public Object getFactObject(Object object) {
        return selfObject.kieSession.getObject(selfObject.kieSession.getFactHandle(object));
    }

    private KieSession createKBfromDrlFile(String drlFileName, Engine engine) throws Exception
    {
        ...
        if ( res.hasMessages( Message.Level.ERROR ) ) {
            throw new Exception(res.getMessages().toString());
        }
    ...
    private KieSession createKBfromDrlSource(String drlSource, Engine engine) throws Exception
    {
        KieHelper helper = new KieHelper();
