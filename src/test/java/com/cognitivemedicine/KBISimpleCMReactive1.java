 ...
 */
public class KBISimpleCMReactive1 {
    ...
    public void initKB()
    {
        ...
        try {
            kbFacilitator = new KBFacilitator(true,"simpleConceptModelReactive1.drl",null, KBSessionInterface.Engine.PHREAK,true);
            assert (true);
        } catch (Exception e) {
            e.printStackTrace();
            assert(false);
    ...
    public void runKB1()
    {
        ...
        kbFacilitator.insertToKB("make-change1");
        kbFacilitator.fireAllRules();
        kbFacilitator.insertToKB("make-change2");
        kbFacilitator.fireAllRules();
     }
    ...
    public void runKB2()
    {
        ...
        Observation obsFact = (Observation)kbFacilitator.getFactObject(observation);
        obsFact.getRelated().get(0).getTarget().getValueQuantity().setValue(150f);
        Assert.assertEquals(0, kbFacilitator.clearVM());
        //kbFacilitator = null;
        //initKB();
        kbFacilitator.insertToKB(obsFact);
        firedNum = kbFacilitator.fireAllRules();
        assertEquals(1, checkList.size());
        System.out.println(firedNum);
    }
    @Test
    public void runKB3()
    {
        ...
        System.out.println(firedNum);
        assertEquals(1, checkList.size());
        kbFacilitator.insertToKB("make-change3");
        kbFacilitator.fireAllRules();
